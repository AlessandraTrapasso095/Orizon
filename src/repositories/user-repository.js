...
// questo file mi serve per incapsulare tutte le query utenti in modo riusabile e senza duplicazioni.

const db = require("../config/database");

// mi serve per creare un utente con dati anagrafici base.
